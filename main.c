...
const uint8_t seg7[]={0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90};
//tablica zawierająca kolejne cyfry z kropką wyświetlane na 3 wyświetlaczu segmentowym
const uint8_t seg7_kropka[] ={0x40,0x79,0x24,0x30,0x19,0x12,0x2,0x78,0x0,0x10};
//tablica przechowująca wartości wysyłane na wyświetlacz
volatile uint16_t dane[1];
